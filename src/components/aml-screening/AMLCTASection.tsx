  ...
  <section className="section-padding bg-navy">
    <div className="container-enterprise">
      <div className="text-center max-w-2xl mx-auto">
        <h2 className="text-white mb-4">Screen Smarter. Monitor Continuously.</h2>
        <p className="text-white/70 text-body-lg mb-8">
          Join regulated institutions using WorldAML to screen customers against global sanctions,
          PEP databases, and adverse media — at onboarding and throughout the relationship.
        </p>
