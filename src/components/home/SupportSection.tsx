...
const supportOptions = [
  {
    icon: FileText,
    title: "Documentation",
    description: "Comprehensive API docs, integration guides, and code examples for fast implementation.",
    link: "/documentation",
  ...
  },
  {
    ...
    description: "Expert assistance from our compliance and engineering teams. Response times defined by plan.",
    link: "/support",
  ...
  },
  {
    ...
    description: "Enterprise-grade reliability with guaranteed uptime and documented response times.",
    link: "/sla",
    linkText: "View SLA",
  },
];
