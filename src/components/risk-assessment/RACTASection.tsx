  ...
  <section className="section-padding bg-navy">
    <div className="container-enterprise">
      <div className="text-center max-w-2xl mx-auto">
        <h2 className="text-white mb-4">Replace Your Risk Spreadsheet with a Compliant, Auditable System</h2>
        <p className="text-white/70 text-body-lg mb-8">
          Join regulated institutions using WorldAML to automate customer risk scoring, satisfy
          regulator expectations, and maintain a defensible risk-based approach at scale.
        </p>
