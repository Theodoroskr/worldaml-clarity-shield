...
const BridgerXGUKIE = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <SEO
        title="Bridger Insight XG® — UK & Ireland"
        description="Bridger Insight XG® for the UK & Ireland region. Enterprise-grade screening with advanced matching algorithms, batch processing, and real-time decisioning."
        canonical="/data-sources/bridger-xg/uk-ie"
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "Data Sources", url: "/data-sources" },
          { name: "Bridger Insight XG®", url: "/data-sources/bridger-xg" },
          { name: "UK & Ireland", url: "/data-sources/bridger-xg/uk-ie" },
        ]}
      />
      <Header />
          ...
          <div className="container-enterprise">
            <div className="max-w-3xl">
              ...
              <p className="text-body-lg text-text-secondary mb-6">
                Enterprise-grade screening solution for UK and Ireland regulated institutions. 
                Bridger Insight® XG automates compliance screening with real-time insights into 
                global sanctions, PEPs, and high-risk entities, integrated with {productStats.profiles} risk profiles.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-body-sm text-text-secondary">Cloud and hosted delivery to meet UK data residency requirements</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-body-sm text-text-secondary">Custom pricing based on volume, subject to compliance assessment</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container-enterprise">
            <div className="bg-white border border-divider rounded-lg p-6 max-w-3xl">
              ...
              <p className="text-body-sm text-text-secondary mb-4">
                Bridger Insight® XG helps UK and Ireland regulated institutions meet FCA and CBI 
                guidance on financial crime prevention, with transparent audit trails and compliance reporting.
              </p>
              <p className="text-body-sm text-text-tertiary">
                Deployment subject to compliance assessment and contractual approval.
              </p>
            </div>
          </div>
        </section>
