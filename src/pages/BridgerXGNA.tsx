...
const BridgerXGNA = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <SEO
        title="Bridger Insight XG® — North America"
        description="Bridger Insight XG® for the North America region. Enterprise-grade screening with advanced matching algorithms, batch processing, and real-time decisioning."
        canonical="/data-sources/bridger-xg/na"
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "Data Sources", url: "/data-sources" },
          { name: "Bridger Insight XG®", url: "/data-sources/bridger-xg" },
          { name: "North America", url: "/data-sources/bridger-xg/na" },
        ]}
      />
      <Header />
