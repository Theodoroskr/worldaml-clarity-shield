        ...
        <section className="section-padding bg-surface-subtle">
          <div className="container-enterprise">
            <div className="max-w-3xl">
              ...
              <h1 className="text-navy mb-6">Bridger Insight XG® — North America</h1>
              ...
              <p className="text-body-lg text-text-secondary mb-8">
                Enterprise-grade screening solution for North American regulated institutions, 
          ...
          <div className="container-enterprise">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-body text-text-secondary mb-6">
                Contact our North American sales team to discuss your requirements.
              </p>
              <Button asChild size="lg">
                <Link to="/get-started">
                  Contact Sales
