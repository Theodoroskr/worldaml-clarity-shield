      ...
      <main className="flex-1">
          ...
          <div className="container-enterprise">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 text-navy mb-4">
                ...
                <span className="text-sm font-medium">UK & Ireland</span>
              </div>
              <h1 className="text-navy mb-6">WorldAML Services — UK & Ireland</h1>
              <p className="text-body-lg text-text-secondary mb-6">
                WorldAML services are available to regulated institutions in the United Kingdom 
                and Ireland, delivered and supported by Infocredit Group.
              </p>
              <div className="flex gap-3">
                <span className="text-sm bg-navy/5 px-3 py-1 rounded-full text-navy">GBP</span>
              ...
              <div className="grid md:grid-cols-2 gap-6 max-w-4xl">
                <Card className="border-divider">
                  ...
                  <CardContent className="space-y-4">
                    <CardDescription>
                      ...
                      Online subscription packages available in GBP / EUR. Enhanced verification required.
                    </CardDescription>
                    <Button variant="outline" asChild size="sm">
                      <Link to="/data-sources/worldcompliance/uk-ie">
                        View Pricing
                        <ArrowRight className="ml-2 h-4 w-4" />
                      </Link>
                    </Button>
                ...
                <Card className="border-divider">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button variant="outline" asChild size="sm">
                      <Link to="/data-sources/bridger-xg/uk-ie">
                        Request Demo
                        <ArrowRight className="ml-2 h-4 w-4" />
                      </Link>
                    </Button>
          ...
          <div className="container-enterprise">
            <div className="bg-white border border-divider rounded-lg p-6 max-w-3xl">
              ...
              <p className="text-body-sm text-text-tertiary">
                <strong>Important:</strong> Access to certain products may require enhanced 
                verification and contractual approval in line with regulatory expectations.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="section-padding bg-navy">
          <div className="container-enterprise text-center">
            <h2 className="text-2xl text-white mb-4">Get Started in UK & Ireland</h2>
